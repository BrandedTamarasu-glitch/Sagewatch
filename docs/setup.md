...
Release users can instead extract `Sagewatch_Plasma_0.1.4_amd64.tar.gz` and run the included `./install.sh`. That bundle contains the prebuilt data helper, widget package, and an `uninstall.sh`; Rust and Node.js are not required.
