...
Index: .forgeflow/Sagewatch/index/memory-index.json
Keywords: (none)
...
- .forgeflow/Sagewatch/current-brief.md:30 [heading] Implementation waves and ownership
- .forgeflow/Sagewatch/current-brief.md:32 [heading] Wave 1 — Scaffold and frozen contracts
- .forgeflow/Sagewatch/current-brief.md:41 [heading] Wave 2 — Store, scheduler, and fake adapters
- .forgeflow/Sagewatch/current-brief.md:49 [heading] Wave 3 — Codex primary adapter
- .forgeflow/Sagewatch/current-brief.md:58 [heading] Wave 4 — Claude primary adapter
- .forgeflow/Sagewatch/current-brief.md:66 [heading] Wave 5 — Product polish and optional alerts
- .forgeflow/Sagewatch/current-brief.md:74 [heading] Wave 6 — Verification and release readiness
- .forgeflow/Sagewatch/current-brief.md:81 [heading] Exact module boundaries
- .forgeflow/Sagewatch/current-brief.md:100 [heading] Locked adapter interface
- .forgeflow/Sagewatch/current-brief.md:109 [heading] Locked domain contract
- .forgeflow/Sagewatch/current-brief.md:148 [heading] Source ingestion rules
- .forgeflow/Sagewatch/current-brief.md:154 [heading] Acceptance gates
- .forgeflow/Sagewatch/current-brief.md:164 [heading] Required tests
...
- .forgeflow/Sagewatch/current-research.md:18 [heading] Claude Teams
- .forgeflow/Sagewatch/current-research.md:27 [heading] Codex subscription
- .forgeflow/Sagewatch/current-research.md:36 [heading] Normalized contract
