# Forgeflow Scope Packet: compass
...
## Lane Files
- scripts/__tests__/claude-statusline-bridge.test.mjs (test, 3308 bytes, score 1, signals compass:test/validation)
- tests/fixtures/claude-model-statusline.json (test, 254 bytes, score 1, signals compass:test/validation)
- tests/frontend/render.test.mjs (test, 3699 bytes, score 1, signals compass:test/validation)
